...
declare module '@promises/core' {
    interface Promises <T> {
        ...
        reduceRightSeries(this: Promises<T>, iteratee?: (accumulator: T[keyof T], value: T[keyof T], key: keyof T, object: T) => IOptionalPromise<T[keyof T]>, accumulator?: T[keyof T]): Promises<T[keyof T]>;
        reduceRightSeries<R>(this: Promises<T>, iteratee?: (accumulator: R, value: T[keyof T], key: keyof T, object: T) => IOptionalPromise<R>, accumulator?: R): Promises<R>;
    }
}
